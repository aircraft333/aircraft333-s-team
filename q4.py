...
附件4 的数据特征（实测）
    ...
    · 逐日均价 0.5378 ~ 0.9290（std 0.104），日内峰谷比均值 4.33
...
def main():
    ...
    fixed = {"对应问题二": 14121654.0, "对应问题三": 13847475.1}      # 来自 q2.py / q3.py 全年结果
    ...
    log(f"  实际平均购电单价：固定电价 {fixed['对应问题二'] / 21795174.4:.4f} 元/kWh"
